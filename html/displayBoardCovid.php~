...
$count = file_get_contents('http://192.168.137.1/api/get_consultaion_slot_in_hospital.php?id=1&type=covid');
...
$r = file_get_contents('http://192.168.137.1/api/patient_in_hospital.php?consult=covid&hospital=3');
