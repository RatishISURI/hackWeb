...
<?php include("header.php")?>
    <h1 class="text-center display-4">View Patient History</h1>
    <div class="container">           
    <div class="mt-5 row">
        <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table class="table user-list">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <img src="images/user_unknown.png" alt="">
                                    <a href="#" class="user-link">Dr Daren Elder</a>
                                </td>
                                <td>
                                    2013/08/08
                                </td>
                                ...
                                <td>
                                    <p>Comment made by doctor goes here...</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
